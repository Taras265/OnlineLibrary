    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_validation_code', models.CharField(default='148800', max_length=6)),
                ('user_type', models.CharField(choices=[(users.enums.UserTypeChoice['LN'], 'Librarian'), (users.enums.UserTypeChoice['RR'], 'Reader')], max_length=10)),
